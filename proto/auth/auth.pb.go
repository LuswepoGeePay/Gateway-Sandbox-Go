...
type AuthResponse struct {
	...
	TokenExpiry   string                 `protobuf:"bytes,9,opt,name=token_expiry,json=tokenExpiry,proto3" json:"token_expiry,omitempty"`
...
const file_auth_proto_rawDesc = "" +
	...
	"\x04role\x18\x05 \x01(\tR\x04role\"\xa6\x01\n" +
	"\x04User\x12\x1a\n" +
	"\bfullname\x18\x01 \x01(\tR\bfullname\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x14\n" +
	"\x05phone\x18\x03 \x01(\tR\x05phone\x12\x1a\n" +
	...
	"\x06portal\x18\x03 \x01(\tR\x06portal\"\xde\x02\n" +
	...
	"\ftoken_expiry\x18\t \x01(\tR\vtokenExpiry\x12%\n" +
	"\x0eemail_verified\x18\n" +
	" \x01(\bR\remailVerified\x12%\n" +
	"\x0eaccount_status\x18\v \x01(\tR\raccountStatus\x12\x14\n" +
	"\x05email\x18\f \x01(\tR\x05email\x12\x1f\n" +
	"\vmerchant_id\x18\r \x01(\tR\n" +
	"merchantIdB\x12Z\x10/proto/auth;authb\x06proto3"
